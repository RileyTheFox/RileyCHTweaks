...
namespace BiendeoCHLib.Wrappers {
	...
	public struct GlobalVariablesWrapper {
		...
		public List<CHPlayerWrapper> PlayerList
		{
			get => ((ICollection)playerListField(GlobalVariables)).Cast<object>().Select(o => CHPlayerWrapper.Wrap(o)).ToList();
		}
		[WrapperField("\u0319\u0315\u031A\u031A\u031A\u0310\u030E\u0317\u0311\u0313\u0316")]
		private static readonly AccessTools.FieldRef<GlobalVariables, object> playerListField;
