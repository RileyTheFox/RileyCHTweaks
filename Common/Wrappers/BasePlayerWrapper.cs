...
namespace Common.Wrappers {
	...
	internal struct BasePlayerWrapper {
		...
		public float SoloAct => (float)soloActField.GetValue(basePlayer);
		[WrapperField("\u0310\u0312\u031C\u0319\u0313\u031B\u0311\u0315\u030F\u031A\u0318")]
		private static readonly FieldInfo soloActField;

		public float EarlyActivation => (float)earlyActField.GetValue(basePlayer);
		[WrapperField("\u0311\u0319\u0319\u0314\u0315\u030E\u0310\u031C\u031A\u0317\u0315")]
		private static readonly FieldInfo earlyActField;

		public float LateActivation => (float)lateActField.GetValue(basePlayer);
		[WrapperField("\u0310\u0310\u0312\u0315\u0310\u031B\u0310\u0315\u031A\u031B\u0318")]
		private static readonly FieldInfo lateActField;

		public float BotWindow => (float)botWindowField.GetValue(basePlayer);
		[WrapperField("\u0316\u0313\u0314\u0317\u031C\u030E\u030F\u0313\u0313\u0319\u030E")]
		private static readonly FieldInfo botWindowField;

		public float WhammyTimer => (float)whammyTimerField.GetValue(basePlayer);
		[WrapperField("\u0316\u0313\u0314\u0317\u031C\u030E\u030F\u0313\u0313\u0319\u030E")]
		...
		public ComboColorWrapper ComboCounter => new ComboColorWrapper((ComboColor)comboCounterField.GetValue(basePlayer));
		[WrapperField("comboCounter")]
		private static readonly FieldInfo comboCounterField;
